...
const adminLogin = 'https://adlinc-api.onrender.com/api/slaschapp/auth/login/admin';
...
export const AuthProvider = (props) => {
  ...
  const signInAdmin = async (email, password) => {
    ...
    const response = await axios.post(adminLogin, { email: email, password: password }, {
      Headers: {
        'Content-Type': 'application/json'
      },
      //withCredentials: false
   ...
   localStorage.setItem('userEmail', userEmail);
   localStorage.setItem('name', 'Adlinc');
