            ...
            <TabContext value={currentTab}>
              ...
              <Card container sx={{
                ...
                <TabPanel value="Inactive">
                  ...
                  {businesses.filter((business) => business.status === 'Inactive').length >= 0 && (
                    <TableContainer>
                      <Table>
                        ...
                        <TableBody>
                          {businesses.filter((business) => business.status === 'Inactive').slice((page - 1) * itemsPerPage, page * itemsPerPage).map((business) => (
                            <TableRow key={business?._id}>
                              <TableCell>{business?.BusinessName}</TableCell>
                              <TableCell>{business?.BusinessCategory}</TableCell>
                              <TableCell>{business?.BusinessLocation}</TableCell>
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'center' }}>
                    <Pagination
                      count={Math.ceil(businesses.filter((business) => business.status === 'Inactive').length / itemsPerPage)}
                      page={page}
                      onChange={handlePageChange}
                      size="small"
                    />
